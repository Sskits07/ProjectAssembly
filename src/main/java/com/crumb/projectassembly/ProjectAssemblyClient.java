...
@Mod(value = ProjectAssembly.MOD_ID, dist = Dist.CLIENT)
// You can use EventBusSubscriber to automatically register all static methods in the class annotated with @SubscribeEvent
@EventBusSubscriber(modid = ProjectAssembly.MOD_ID, value = Dist.CLIENT)
public class ProjectAssemblyClient {
    public ProjectAssemblyClient(ModContainer container) {
